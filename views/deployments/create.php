<?php
$page_title = 'Create Deployment - Resource Allocation System';
$action = 'deployments';
?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="incident_id" name="incident_id" required>
                            ...
                            <option value="<?= $incident['id'] ?>">
                                <?= htmlspecialchars($incident['title']) ?> - <?= htmlspecialchars($incident['location_name']) ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="driver_id" name="driver_id" required>
                                    ...
                                    <option value="1">John Smith (AMB-001)</option>
                                    <option value="2">Maria Garcia (AMB-002)</option>
                                    <option value="3">Robert Johnson (FT-001)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="vehicle_id" name="vehicle_id" required>
                                    ...
                                    <option value="1">Ambulance AMB-001</option>
                                    <option value="2">Ambulance AMB-002</option>
                                    <option value="3">Fire Truck FT-001</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    incidentSelect.addEventListener('change', function() {
        ...
        if (selectedOption.value) {
            ...
            if (selectedIncident) {
                endLocationInput.value = selectedIncident.location_name;
